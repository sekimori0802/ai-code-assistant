          ...
          {rooms.length === 0 ? (
            ...
            rooms.map((room) => (
              <div
                ...
                className="bg-white p-4 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors duration-200 border border-gray-200 shadow"
              >
                <div className="flex flex-col">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-gray-500">
                      {new Date(room.last_message_at || room.created_at).toLocaleString('ja-JP', { timeZone: 'Asia/Tokyo' })}
                    </span>
                  </div>
